                                ...
                                <div class="card-body card-block">
                                    <form method="post" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="vat" class="form-control-label">Add Opt1</label><input type="file" name="fopt1" class="form-control"></div>
                                        <div class="form-group">
                                        <img src="<?php echo $opt2; ?>" height="50" width="50"> <br>
                                        <label for="vat" class="form-control-label">Add Opt2</label><input type="file" name="fopt2" class="form-control"></div>
                                        <div class="form-group">
                                        <img src="<?php echo $opt3; ?>" height="50" width="50"> <br>
                                        <label for="vat" class="form-control-label">Add Opt3</label><input type="file" name="fopt3" class="form-control"></div>
                                        <div class="form-group">
                                        <img src="<?php echo $opt4; ?>" height="50" width="50"> <br>    
                                        <label for="vat" class="form-control-label">Add Opt4</label><input type="file" name="fopt4" class="form-control"></div>
                                        <div class="form-group">
                                        <img src="<?php echo $answer; ?>" height="50" width="50"> <br>    
                                        <label for="vat" class="form-control-label">Add Answer</label><input type="file" name="fanswer" class="form-control"></div>
                                        <div class="form-group">
...
if(isset($_POST["submit2"])) {
    ...
    if($opt1!="")
    {
        $dst1 = "./opt_images/" . $tm . $fopt1; // Corrected concatenation operator
        $dst_db1 = "opt_images/" . $tm . $opt1; // Corrected concatenation operator
    ...
    if($opt2!="")
    {
        $dst2 = "./opt_images/" . $tm . $fopt2; // Corrected concatenation operator
        $dst_db2 = "opt_images/" . $tm . $opt2; // Corrected concatenation operator
    ...
    if($opt3!="")
    {
        $dst3 = "./opt_images/" . $tm . $fopt3; // Corrected concatenation operator
        $dst_db3 = "opt_images/" . $tm . $opt3; // Corrected concatenation operator
    ...
    if($opt4!="")
    {
        $dst4 = "./opt_images/" . $tm . $fopt4; // Corrected concatenation operator
        $dst_db4 = "opt_images/" . $tm . $opt4; // Corrected concatenation operator
    ...
    if($answer!="")
    {
        $dst5 = "./opt_images/" . $tm . $answer; // Corrected concatenation operator
        $dst_db5 = "opt_images/" . $tm . $answer; // Corrected concatenation operator
